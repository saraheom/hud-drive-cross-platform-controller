...
INSTALL=['install_once.sh','libu2w_mainvideo_live.so','u2wvideo-status-v818.cgi']
UNINSTALL=['uninstall_once.sh','libu2w_mainvideo_live_v811.so','u2wvideo-status-v811.cgi']
...
for names,once,outname in [
 (INSTALL,'install_once.sh','U2W_Update_v8.18_MainVideoFDReselect.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.18_MainVideoFDReselect_UNINSTALL.img')]:
