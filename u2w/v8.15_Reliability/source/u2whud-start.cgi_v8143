...
'
echo 'U2W HUD Live Frame Relay v8.14.3'
start_one(){
...
echo 'Repeated Start is idempotent. MJPEG relay is SIGPIPE-safe, primes with known-good frames, then serves live baseline 480x240 JPEG.'
