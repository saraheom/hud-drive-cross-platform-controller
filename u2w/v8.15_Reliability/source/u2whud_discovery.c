/* U2W v8.15 persistent KivicCast discovery responder with session-scoped markers. */
...
void _start(void){
 ...
 for(;;){
  ...
  touch_marker("/tmp/u2whud_session_discovery");
