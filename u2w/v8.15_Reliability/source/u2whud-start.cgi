...
echo 'U2W HUD Live Frame Relay v8.15'
SID=0
...
echo 'v8.15 uses session-scoped discovery/client/live-frame markers; healthy relay daemons are preserved across HUD display Stop/Start.'
