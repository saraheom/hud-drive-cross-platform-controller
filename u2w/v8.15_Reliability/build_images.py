...
INSTALL=[
 'install_once.sh','libu2w_rgd_preload.so','u2w_mainvideo_streamer',
 'u2whud_cast_relay','u2whud_discovery','u2whud_frame_ingress','u2whud_test.jpg','u2whud_stop.sh',
 'u2whud-start.cgi','u2whud-stop.cgi','u2whud-status.cgi'
]
UNINSTALL=[
 'uninstall_once.sh','libu2w_rgd_preload_v88.so','u2wvideo-main-stream-v811.cgi',
 'u2whud_cast_relay_v8143','u2whud_discovery_v8143','u2whud_frame_ingress_v8143',
 'u2whud_test.jpg_v8143','u2whud_stop.sh_v8143',
 'u2whud-start.cgi_v8143','u2whud-stop.cgi_v8143','u2whud-status.cgi_v8143'
]
...
outputs=[
 (INSTALL,'install_once.sh','U2W_Update_v8.15_Reliability.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.15_Reliability_UNINSTALL.img')
]
for names,once,outname in outputs:
