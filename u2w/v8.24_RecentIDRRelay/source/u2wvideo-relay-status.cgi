...
echo 'U2W MainVideo Recent-IDR Relay v8.24 status'
echo "marker=$([ -f /etc/u2w_v8_24_recent_idr_relay.marker ] && echo YES || echo NO)"
...
echo '--- relay log ---'
tail -n 96 /tmp/u2w_mainvideo_relay.log 2>/dev/null || true
