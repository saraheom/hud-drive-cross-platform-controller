...
INSTALL=['install_once.sh','u2whud_cast_relay','u2whud-start.cgi','u2whud-stop.cgi','u2whud-status.cgi']
UNINSTALL=['uninstall_once.sh','u2whud_cast_relay_v815','u2whud-start.cgi_v815','u2whud-stop.cgi_v815','u2whud-status.cgi_v815']
...
for names,once,outname in [
 (INSTALL,'install_once.sh','U2W_Update_v8.15.1_NoKnownImagePrimer.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.15.1_NoKnownImagePrimer_UNINSTALL.img')]:
