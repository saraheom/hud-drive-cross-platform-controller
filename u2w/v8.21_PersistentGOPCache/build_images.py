...
INSTALL=['install_once.sh','u2w_mainvideo_cache','u2w_mainvideo_streamer','u2wvideo-cache-start.cgi','u2wvideo-cache-status.cgi']
UNINSTALL=['uninstall_once.sh','u2w_mainvideo_streamer_v820']
...
for names,once,outname in [
 (INSTALL,'install_once.sh','U2W_Update_v8.21_PersistentGOPCache.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.21_PersistentGOPCache_UNINSTALL.img')]:
...
(BASE/'U2W_v8.21_SHA256SUMS.txt').write_text(''.join(f'{d}  {n}\n' for n,d in rows))
