...
echo 'U2W MainVideo Live-IDR Relay v8.23 status'
echo "marker=$([ -f /etc/u2w_v8_23_live_idr_relay.marker ] && echo YES || echo NO)"
...
echo '--- relay log ---'
tail -n 64 /tmp/u2w_mainvideo_relay.log 2>/dev/null || true
