...
UNINSTALL=['uninstall_once.sh','u2w_mainvideo_relay_v822','u2wvideo-relay-start-v822.cgi','u2wvideo-relay-status-v822.cgi','u2whud_cast_relay_v822']
...
for names,once,outname in [
    (INSTALL,'install_once.sh','U2W_Update_v8.23_LiveIDRRelay.img'),
    (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.23_LiveIDRRelay_UNINSTALL.img')]:
...
(BASE/'U2W_v8.23_SHA256SUMS.txt').write_text(''.join(f'{d}  {n}\n' for n,d in rows))
