...
INSTALL=['install_once.sh','u2w_mainvideo_relay','u2wvideo-relay-start.cgi','u2wvideo-relay-status.cgi','u2whud_cast_relay_v822']
UNINSTALL=['uninstall_once.sh','u2whud_cast_relay_v8151']
...
for names,once,outname in [
    (INSTALL,'install_once.sh','U2W_Update_v8.22_DedicatedH264Relay.img'),
    (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.22_DedicatedH264Relay_UNINSTALL.img')]:
...
(BASE/'U2W_v8.22_SHA256SUMS.txt').write_text(''.join(f'{d}  {n}\n' for n,d in rows))
