...
UNINSTALL=['uninstall_once.sh','u2w_mainvideo_streamer_v815']
...
for names,once,outname in [
 (INSTALL,'install_once.sh','U2W_Update_v8.16_LiveEdgeMainVideo.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.16_LiveEdgeMainVideo_UNINSTALL.img')]:
