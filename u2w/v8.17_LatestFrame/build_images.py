...
UNINSTALL=['uninstall_once.sh','u2w_mainvideo_streamer_v816']
...
for names,once,outname in [
 (INSTALL,'install_once.sh','U2W_Update_v8.17_LatestFrame.img'),
 (UNINSTALL,'uninstall_once.sh','U2W_Update_v8.17_LatestFrame_UNINSTALL.img')]:
