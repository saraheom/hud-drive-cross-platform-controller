...
P=/tmp/update/tmp
DIR=/usr/lib/u2whud
MARK=/etc/u2whud_bridge_v8_14_3.marker
log(){ echo "[U2W-HUD-RELAY-v8.14.3] $*" > /dev/console; }
...
rm -f /etc/u2whud_bridge_v8_12.marker /etc/u2whud_bridge_v8_13.marker /etc/u2whud_bridge_v8_14.marker /etc/u2whud_bridge_v8_14_1.marker /etc/u2whud_bridge_v8_14_2.marker /etc/u2whud_bridge_v8_14_3.marker
...
cat > "$MARK" <<MARKER
U2W HUD Live Frame Relay v8.14.3
...
MARKER
sync
log 'installed; SIGPIPE-safe robust MJPEG relay + persistent discovery available via u2whud-start.cgi'
