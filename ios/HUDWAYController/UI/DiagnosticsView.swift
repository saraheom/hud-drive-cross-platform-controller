    ...
    var body: some View {
        List {
            ...
            Section("ANCS / Notification diagnostics") {
                ...
                Text("The app now uses the normal HUDWAY BLE connection and observes CoreBluetooth’s `ancsAuthorized` state. If iOS authorizes ANCS for the accessory, the log will record the authorization change.")
                    .font(.caption)
