...
final class LogManager {
    ...
    private var logDirectory: URL {
        ...
        return documents.appendingPathComponent("HUD Logs", isDirectory: true)
    }
    ...
    func startSession() {
        ...
        currentFileURL = logDirectory.appendingPathComponent("HUD_\(formatter.string(from: Date())).log")
