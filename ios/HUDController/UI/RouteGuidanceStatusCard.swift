    ...
    var body: some View {
        HudCard {
            VStack(alignment: .leading, spacing: 10) {
                ...
                HudDescription("Source priority: Google Maps > Apple Maps > Waze. A higher-priority source wins only while its Route Guidance stream is fresh. There is no OCR fallback: stale/unavailable adapter data returns the HUD to Freeride automatically. Navigation dashboard default: Speed on the left, ETA on the right.")
