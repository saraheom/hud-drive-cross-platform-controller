...
check("5s decode freshness", "decoderStaleFrameInterval: TimeInterval = 5.0" in client)
check("8s reconnect cooldown", "freshnessReconnectCooldown: TimeInterval = 8.0" in client)
