...
check("bounded decoder-output freshness", "decoderStaleFrameInterval: TimeInterval = 3.0" in client and "HARD decoder recovery, reconnect recent-IDR bootstrap" in client)
