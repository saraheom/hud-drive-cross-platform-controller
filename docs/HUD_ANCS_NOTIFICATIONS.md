# HUD iPhone Notifications / ANCS

## Confirmed architecture

The decompiled HUD client contains the instruction:
...
Notification Provider and HUD Drive is the external ANCS Notification
...
is enabled in the iPhone Bluetooth settings for HUD Drive.
...
If map guidance reaches HUD over ANCS, that confirms a useful data path to
